                              ...
                              <?php
							   ...
							   ?>
							    <div class="alert alert-success">
									...
									{
										echo $msg = 'This Item Group  is parent, so we can not delete';
									}
									?>
								</div>
								<?php
            ...
            <!-- BEGIN PAGE CONTENT-->
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="clearfix">
                                <div class="btn-group">
                                <a href="ItemGroup1Edit.php?action=Add"  role="button" class="btn green" data-toggle="modal">Add New <i class="icon-plus"></i></a>								
									</div>
								</div>
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											{
											?>
                                            <a href="ItemGroup1Edit.php?fItemGroup1Id=<?php echo  urlencode($item['id_itemgroup1']); ?>&action=edit" class="btn mini purple"><i class="icon-edit"></i>Edit</a> &nbsp; &nbsp;
                                            
                                            <a  class="delete btn mini black" href="javascript:void()" onclick=deleteBox('<?php echo  $item['id_itemgroup1']; ?>','itemgroup1delete','Move')><i class="icon-trash"></i>Delete</a>   <?php } else { ?>
                                            
                                              <a href="ItemGroup1Edit.php?fItemGroup1Id=<?php echo  urlencode($item['id_itemgroup1']); ?>&action=edit" class="btn mini purple"><i class="icon-edit"></i>Edit</a> &nbsp; &nbsp;
											   <a  class="delete btn mini black" href="javascript:void()" onclick=deleteBox('<?php echo  $item['id_itemgroup1']; ?>','itemgroup1delete','Permanent')><i class="icon-trash"></i>Delete</a>
