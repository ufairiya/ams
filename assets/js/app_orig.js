var App = function () {
    ...
    var handleFormValidation = function () {
        ...
        assettypeform.validate({
            ...
            errorPlacement: function (error, element) { // render error placement for each input type
                 if (element.attr("name") == "fStatus") { // for uniform radio buttons, insert the after the given container
                    error.addClass("no-left-padding").insertAfter("#form_2_membership_error");
                }  else {
                    error.insertAfter(element); // for other inputs, just perform default behavoir
                }
        ...
        $('.chosen, .chosen-with-diselect', assettypeform).change(function () {
            assettypeform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', group1form).change(function () {
            group1form.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', contractform).change(function () {
            contractform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', countryaddnewform).change(function () {
            countryaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', currencyaddnewform).change(function () {
            currencyaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        //apply validation on chosen dropdown value change, this only needed for chosen dropdown integration.
        $('.chosen, .chosen-with-diselect', stateaddnewform).change(function () {
            stateaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', cityaddnewform).change(function () {
            cityaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', companyaddnewform).change(function () {
            companyaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', divisionaddnewform).change(function () {
            divisionaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', storeaddnewform).change(function () {
            storeaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', unitaddnewform).change(function () {
            unitaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', supplieraddnewform).change(function () {
            supplieraddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', contactaddnewform).change(function () {
            contactaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', employeeaddnewform).change(function () {
            employeeaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', purchaserqcreateform).change(function () {
            purchaserqcreateform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
	
		
		// End Purchase Request create		
	...
	// TaxForm  new 
        ...
        $('.chosen, .chosen-with-diselect', taxaddnewform).change(function () {
            taxaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', uomaddnewform).change(function () {
            uomaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', termsaddnewform).change(function () {
            termsaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', vendortypeaddnewform).change(function () {
            vendortypeaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', fuellimitaddnewform).change(function () {
            fuellimitaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
...
var mainaddnewform = $('#form_maintenance');
        ...
        $('.chosen, .chosen-with-diselect', mainaddnewform).change(function () {
            mainaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', manuaddnewform).change(function () {
            manuaddnewform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', roleform).change(function () {
            roleform.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', register).change(function () {
            register.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
        ...
        $('.chosen, .chosen-with-diselect', register1).change(function () {
            register1.validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
        });
