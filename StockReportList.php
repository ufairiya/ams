		...
		else
		{
		 	$field = '';
              		...
              		$numrows 		= $astockReportListcount; //$oDb->num_rows;
	   	  		  	...
	   	  		  	$astockReportList 	= $oReport->stockReportList( $sesReportItemList,'', $offset, $rowsPerPage, $field, $sort);
...
<head>
   <meta charset="utf-8" />
   <title>EAMS| Stock Report List </title>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li><a href="#">Stock Report List</a></li>
                  </ul>
               </div>
            </div>
                              ...
                              <?php
							   ...
							   ?>
							    <div class="alert alert-success">
									...
									{
										echo $msg = 'New Stock Report Added Successfully';
									}
									else if($aRequest['msg'] == 'updatesucess')
									{
										echo $msg = 'Stock Report Updated Successfully';
									}
									else if($aRequest['msg'] =='delsuccess')
									{
										echo $msg = 'Stock Report Deleted Successfully';
									}
									else if($aRequest['msg'] =='undelsuccess')
									{
										echo $msg = 'This Stock Report is parent, so we can not delete';
									}
									?>
								</div>
								<?php
