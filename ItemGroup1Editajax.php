...
if (empty($action)) {
	...
	<div class='contact-content'>
		<h1 class='contact-title'>Add a Item Group 1:</h1>
		<div class='contact-loading' style='display:none'></div>
		<div class='contact-message' style='display:none'></div>
		<form action='#' style='display:none'>
			<label for='contact-name'>*Item Group 1 Name:</label>
			<input type='text' id='contact-name' class='contact-input' name='fItemGroup1Name' tabindex='1001' />
			<br>
			".$html."
			\n";
	...
	$output .= "
			<label>&nbsp;</label>
			<button type='submit' class='contact-send contact-button' tabindex='1006'>Add Item Group1</button>
	...
	// Send the email
	$aRequest = array();
	$aRequest['fItemGroup1Name']  = isset($_POST["fItemGroup1Name"]) ? $_POST["fItemGroup1Name"] : ""; 
