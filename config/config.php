...
define ('DB_NAME',       	'amstest');
define ('ADMIN_APP_ROOT', 		$_SERVER['DOCUMENT_ROOT'].'/amstest/admin');
define ('ADMIN_APP_HTTP',  		'http://' . $_SERVER['SERVER_NAME']."/amstest/admin");
...
define ('APP_HTTP', 			'http://' . $_SERVER['SERVER_NAME'].'/amstest');
define ('APP_HTTPS',            'https://' . $_SERVER['SERVER_NAME'].'/amstest');
define ('APP_ROOT', 			$_SERVER['DOCUMENT_ROOT'].'/amstest');
